...
class Resort(models.Model):
    ...
    )  # Stores a single point (latitude/longitude)
...
class skiarea(models.Model):
    skiarea_pk = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    id = models.IntegerField(null=True)
    scalerank = models.IntegerField(null=True)
    passaffiliation = models.CharField(
        max_length=255, null=True, default="Unaffiliated"
    )
...
class trail(models.Model):
    trail_pk = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
...
class glade(models.Model):
    glade_pk = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    name = models.CharField(null=True)
    difficulty = models.CharField(null=True)
    piste_type = models.CharField(null=True)
...
class ski_area_isochrone(models.Model):
